...
require_once('./app/PHPMailer/class.smtp.php');
     ...
     try { 
        ...
        $mail->AddAddress($correo, $correoUsuario, 'compras@gmail.com');      //Direccion a la que se envia
        $mail->SetFrom('cxpferreterapegaso@gmail.com' , "Cuentas por pagar"); // Esccribe datos de contacto
