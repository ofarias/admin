<?php
    ...
    require_once('./app/PHPMailer/class.smtp.php');
     ...
     endforeach;
     $asunto = "Cancelacion de Factura $docf Ferretera Pegaso.";  
     $mensaje.= "<p>Le informamos que se ha cancelado la factura $FACTURA.</p>";
     $mensaje.= "<p>Si usted piensa que es un error favor de verificarlo con el usuario $usuario <br/> <br/> <br/> Atentamente Cuentas x Cobrar <br/><br/> Ferretera Pegaso</p>";
     try {
        ...
        $mail->Username   = "cxpferreterapegaso@gmail.com";  // Nombre del usuario SMTP
         ...
         $mail->SetFrom('cxpferreterapegaso@gmail.com' , "Pegaso. Aviso de Cancelacion de Factura".$docf); // Esccribe datos de contacto
         $mail->Subject = $asunto;
