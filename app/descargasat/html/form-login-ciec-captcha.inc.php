<form method="POST" class="login-form">
  ...
  <div class="row">
    <div class="col-sm-3 form-group">
      ...
      <input type="text" class="form-control" id="login-ciec-rfc" name="rfc" value="">
    </div>
    <div class="col-sm-3 form-group">
      <label for="login-ciec-pwd">Contraseña</label>
      <input type="password" autocomplete="new-password" class="form-control" id="login-ciec-pwd" name="pwd" value="">
    </div>
    <div class="col-sm-4 form-group">
      ...
      <div class="input-group">
        ...
        <span class="input-group-addon" style="padding:0;overflow:hidden;padding:0 10px;background:#fff;">
          <img style="height:42px" src="data:image/jpeg;base64,<?php echo $descargaCfdi->obtenerCaptcha(); ?>" />
        </span>
